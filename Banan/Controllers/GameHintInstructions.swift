...
import Foundation
protocol GameHintInstructionsViewControllerDelegate {
    func didDoneButtonTapped()
}
class GameHintInstructionsViewController : UIView {
    static let instance = GameHintInstructionsViewController()
    ...
    var delegate : GameHintInstructionsViewControllerDelegate?
    
    
    override init(frame: CGRect) {
        super.init(frame: frame)
        
        Bundle.main.loadNibNamed("GameHintInstructionsView", owner: self, options: nil)
    ...
    private func commonInit() {
       ...
       Bundle.main.loadNibNamed("GameHintInstructionsView", owner: self, options: nil)
       let letterGif = UIImage.gifImageWithName("GameHintInstructions")
      let imgeView = UIImageView(image: letterGif)
       imgeView.frame = CGRect(x: -10, y: 30, width: 580, height: 500)
