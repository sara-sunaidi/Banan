...
class Hint5ViewController : UIView {
    ...
    static let instance = Hint5ViewController()
    ...
    var delegate: Hint5ViewControllerDelegate?

    
    override init(frame: CGRect) {
        super.init(frame: frame)
        
        Bundle.main.loadNibNamed("Hint5View", owner: self, options: nil)
