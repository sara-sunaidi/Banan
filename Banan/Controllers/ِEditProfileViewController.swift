//
//  ِEditProfileViewController.swift
//  Banan
//
//  Created by Shaden Al on 26/08/1443 AH.
//
import Firebase
import UIKit
import Foundation
...
class EditProfileViewController: UIViewController , UITextFieldDelegate ,CustomAcknowledgementViewControllerDelegate {
    ...
    func setChildInfo(child: Child){
       ...
       // print(date)
        ...
        print("dddcccccccccccdd",  calcyear)
