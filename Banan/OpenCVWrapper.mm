...
//    drawKeypoints(mat, initKeypoints, detectedCoordinatesImg, cv::Scalar(255, 0, 26), cv::DrawMatchesFlags::DRAW_RICH_KEYPOINTS);
//
...
//        drawKeypoints(red_hue_image, keypoints, detectedImg, cv::Scalar(255, 0, 26), cv::DrawMatchesFlags::DRAW_RICH_KEYPOINTS);
//
...
//               line(coordinateImg, cv::Point(coordinateX[i], 0), cv::Point(coordinateX[i], coordinateImg.rows), cv::Scalar(255, 0, 0));
//           }
//           for (int i = 0; i < static_cast<int>(coordinateY.size()); ++i) {
//               line(coordinateImg, cv::Point(0, coordinateY[i]), cv::Point(coordinateImg.cols, coordinateY[i]), cv::Scalar(255, 0, 0));
//           }
//
